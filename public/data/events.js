...
export const events = [
  ...
  },
  {
    ...
    logo: "/assets/hackw.jpg",
    description:
      "ACM ABESEC is bringing it's Recruitment drive 2022 so roll up your sleeves and get ready to experience the most interesting tech recruitment.Hello techies ≡ƒÿÄ ACM ABESEC is bringing it's Recruitment drive 2022 so roll up your sleeves and get ready to experience the most interesting tech recruitment.Open to all the branches of 2nd year for the first time Details of recruitment - ≡ƒæëRound 1:- Aptitude Round Date :- 21st February, 22 Offline aptitude test will be held in Seminar Hall You will be informed before hand about your slot and venue. ≡ƒæë There will be total 30 questions consisting of 20 questions of aptitude and 10 questions of basic programming & CS Fundamentals ≡ƒæëRound 2 :- Code Hunt Γû½∩╕ÅDate :- 22nd February, 22 ≡ƒæë You will be given a puzzle and solving it you will reach to a specific place in college premises, there you will get another puzzle and so on. At the last stage you will get a basic coding problem to solve. Top 30 participants will be shortlisted for the next round ≡ƒæëRound 3:- Personal Interview Γû½∩╕ÅDate :- 23rd February, 22 Γû½∩╕ÅTime :- Time slots will be assigned to all the shortlisted candidates for their personal interviews ≡ƒæëDetails of this round will be floated to the participants selected for this round.",
  },
  {
  ...
  },
  {
    ...
    logo: "/assets/hackw.jpg",
    description:
      "Make it Right ΓÇ╝∩╕Å Make it Work ΓÇ╝∩╕Å Make it Fast. ΓÇ╝∩╕Å Hello Coders ≡ƒñù ≡ƒö┤ACM ABESEC is organising 'Code Your Way' coding contest for the 1st , 2nd , 3rd year students.►Contest is for all levels of programmer from beginner to advance►The contest is op en to anyone with a knack for programming►Compete to know , where you stand in midst of programmer",
  },
  {
  ...
  },
  {
    ...
    logo: "/assets/dev.jpg",
    description:
      "≡ƒæëYou will be given 6 questions ~Out of which 4 questions will be on pseudocode and 2 questions on debugging. ≡ƒÉ¢ ≡ƒæëYou have to arrange all the 6 outputs in a logical way to make a String ≡ƒæ¿ΓÇì≡ƒÆ╗ This string will be a question and the answer to that string will be the Final Answer. ≡ƒöÑPrize Bluetooth sp eakers, Paytm vouchers It's a game of time. The faster you solve, your chances of winning increases. ~All the best.",
  },
  // {
  ...
  },
  {
    ...
    logo: "/assets/dev.jpg",
    description:
      "We are inviting you to participate in the acclaimed ACM W ABESEC INTERNAL VIRTUAL HACKATHON This hackathon will be conducted in Virtual format. The theme of the hackathon is 'Self Reliant IndiaΓÇÖ a small step towards Self Reliant India for innovative ideas using IT Solution in various domains such as Health Care, Finance, Agriculture, Education, Social innovationWe are inviting you to participate in the acclaimed ACM W ABESEC INTERNAL VIRTUAL HACKATHONThis hackathon will be conducted in Virtual format.The theme of the hackathon is 'Self Reliant India’ a small step towards Self Reliant India for innovative ide as using IT Solution in various domains such as Health Care, Finance, Agriculture,Education, Social innovationEligibility Criterion1. All girls team of 1 to 3 members2. Open for all years",
  },
];
